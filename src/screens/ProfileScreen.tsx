...
export function ProfileScreen() {
  ...
  const handleOpenPrivacy = async () => {
    try {
      ...
      Alert.alert(
        "Unable to open link",
        "Could not open Privacy Policy. Try again later.",
      );
    }
  };
  ...
  const handleOpenTerms = async () => {
    try {
      ...
      Alert.alert(
        "Unable to open link",
        "Could not open Terms of Service. Try again later.",
      );
    }
  };
  ...
  const handleClaimDailyBonus = () => {
    ...
    Alert.alert(
      result.ok ? "Daily Bonus" : "Come Back Tomorrow",
      result.message,
    );
  };
          ...
          <View style={styles.hero}>
            ...
            <View style={styles.heroBadges}>
              ...
              >
                ...
                />
                <Text
                  style={[styles.lifeStageText, { color: avatarRingColor }]}
                >
                  {lifeStage}
                </Text>
              </View>
              ...
              {dailyQuests.map((q) => (
                <Pressable
                  ...
                  onPress={() => {
                    ...
                    Alert.alert(
                      result.ok ? "Quest Complete" : "Quest",
                      result.message,
                    );
                  }}
